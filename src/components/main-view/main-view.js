...
import { ListIcon, TableIcon,RocketIcon , WorldIcon} from '@commercetools-uikit/icons';
    ...
    <Spacings.Inset scale="m">
      <Spacings.Stack scale="m">
        ...
        <Switch>
          ...
          <Route path={`${props.match.path}/home-page`} component={HomePage} />
        </Switch>
      </Spacings.Stack>
    </Spacings.Inset>
  );
